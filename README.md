...
[![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/polysche.svg)](https://anaconda.org/conda-forge/polysche)

The goal of this C++17 library is to statically (eventually at compile-time using constexpr expressions) **generate stencils** involved
...
This library currently looks more like a proof of concept than a mature project.
However, here is some features that are planned to be added (also seed the [`TODO.md`](TODO.md) file):
