...
int main()
{
    ...
    std::cout << "Finite differences of order 2 with Neumann boundary condition:" << std::endl;
     auto PS = PolynomialScheme<2>{}; // Order 2
     auto P = PS.get_polynomial();
     auto S = PS.add_eqn(P.derivate()(0)) // u'_0
                        .add_eqn(P( 0)) // u_0
                        .add_eqn(P( 1)) // u_1
                        .solve();
    ...
    std::cout << "Finite volumes of order 2:" << std::endl;
     auto PS = PolynomialScheme<2>{};
     auto P = PS.get_polynomial();
     auto S = PS.add_eqn(P.integrate({-3, 2}, {-1, 2})) // u_{-1}
